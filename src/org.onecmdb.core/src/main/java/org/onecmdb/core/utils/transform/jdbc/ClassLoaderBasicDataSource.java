...
public class ClassLoaderBasicDataSource implements DataSource {
     ...
     */
    protected int defaultTransactionIsolation = -1; //PoolableConnectionFactory.UNKNOWN_TRANSACTIONISOLATION;
